...
*-v*::
  Verbose listing. When used with *-l* in tarball mode, prints the compressed block offset and uncompressed tar offset for each file, in the format: `compressed_offset uncompressed_offset filename`.
