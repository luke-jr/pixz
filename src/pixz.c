...
"  pixz -S -D 64M input.tpxz | pixz -9 > out.tpxz  # Recompress with 64M dict\n"
...
"  -D SIZE            LZMA dictionary size used to classify large files (used with -S);\n"
"                     files >= SIZE are sorted last; SIZE is in MiB when no suffix given;\n"
"                     K/M/G accepted (default: matches liblzma default preset)\n"
