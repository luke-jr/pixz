...
"  pixz -l -v input.tpxz           # List with block compressed offset, uncompressed offset within block, block size\n"
...
"  -v                 With -l in tarball mode, print for each file: compressed\n"
"                     block offset, uncompressed offset within that block, block\n"
